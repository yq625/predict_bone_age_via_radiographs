...
def train_model(model, dataloader, optimizer, loss_fn, num_epochs = 10, verbose = False):
    ...
    for i in range(num_epochs):
        ...
        if (i%10 == 0):
            torch.save(best_model_wts, 'resnet34_onlyfc_40ep.wts')
...
torch.save(best_model.state_dict(), 'resnet34_onlyfc_40ep.pkl')

        
with open('loss_train_resnet34_onlyfc_40ep.txt', 'w') as f:
        f.write(str(loss_dict['train']))
with open('loss_validate_resnet34_onlyfc_40ep.txt', 'w') as f:
